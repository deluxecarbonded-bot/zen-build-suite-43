...
import { Search, Settings, Moon, Sun, Eye, Palette, MousePointer, Filter, Heart, BookOpen, Plus, X, Brain, Zap, Layout, Clock, Shield, Sparkles, Timer, RefreshCw, ArrowLeft, ArrowRight, Home, Globe, Leaf, Maximize, Minimize } from 'lucide-react';
